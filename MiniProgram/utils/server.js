...
function __args() {
  ...
  if (setting.url.indexOf('http://') !== 0) {
    // setting.url = 'http://my.wxshop.com/index.php/WXAPI' + setting.url;
    //http://shops.wudhl.com/index.php/WXAPIhttps://www.505coder.com
    
    setting.url = 'https://foods.woshangapp.com/index.php/WXAPI' + setting.url;
    //setting.url = 'http://mv.wxshop.com/index.php/WXAPI' + setting.url;
  }
  return setting;
}

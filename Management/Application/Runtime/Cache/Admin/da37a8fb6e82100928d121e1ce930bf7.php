       ...
       <div class="row">
			...
			<div class="box box-info">
                <div class="box-header with-border">
                  ...
                  <a href="<?php echo U('Store/store_article_list',array('store_id'=>$store_id));?>" data-toggle="tooltip" title="" class="btn btn-default pull-right" data-original-title="返回"><i class="fa fa-reply"></i></a>
                </div>
                <form class="form-horizontal" action="<?php echo U('Store/store_article_handle');?>" id="add_post" method="post">
					<input type="hidden" name="store_id" value="<?php echo ($store_id); ?>" />
                  <div class="box-body">
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">店铺名称</label>
						<div class="col-sm-8">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo ($store_name); ?></label>
						</div>
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <div class="col-sm-2">
                           <label><input type="radio" name="is_open" value="1"> 显示 </label>                          
                        </div>
                         <div class="col-sm-3">

    ...
    */
    ...
    public function do_login()
    {
        ...
        if ($res['status'] == 1) {
            ...
            $nick_name = empty($res['result']['nick_name']) ? $username : $res['result']['nick_name'];
            setcookie('uname', $nick_name, null, '/');
    ...
    public function userinfo()
    {
        ...
        if (IS_POST) {
            I('post.nick_name') ? $post['nick_name'] = I('post.nick_name') : false; //昵称

                                    ...
                                    <label class="control-label col-sm-2"></label>                                    
                                         <div id="ajax_brandList" class="ajax_bradnlist">                                                
                                            <?php if(is_array($goods_category_list)): foreach($goods_category_list as $k=>$v): ?><ul>
                                                        ...
                                                        <?php if(is_array($goods_type_list)): foreach($goods_type_list as $k2=>$v2): ?><li><input type="radio" name="type_id" value="<?php echo ($v2['id']); ?>" checked="checked" />&nbsp;&nbsp;<?php echo ($v2['name']); ?></li><?php endforeach; endif; ?>
                                                    </ul>
<!--                                                     <ul>
                                                        <h5 id="type_id_<?php echo ($v[id]); ?>"><strong><?php echo ($v[name]); ?></strong></h5>

...
return array(
    ...
    'LOAD_EXT_CONFIG' => 'route', // 加载数据库配置文件
    
     /* 数据库配置 */
    'DB_TYPE' => 'mysql', // 数据库类型
    'DB_HOST' => 'localhost', // 服务器地址
    'DB_NAME' => 'maicaitwo', //数据库名称
    'DB_USER' => 'root', //数据库用户名
    'DB_PWD' => 'root', //数据库密码
    'DB_PORT' => '3306', //数据库端口
    'DB_PREFIX' => 'ty_', //数据库前缀
...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    'WAITSEND' => ' AND (pay_status = 1 OR pay_code="weixin") AND shipping_status !=1 AND order_status in(0,1) ', //订单查询状态 待发货
    ...
    'CUSTOMER' => 'AND  shipping_status= 1 AND order_status = 5 AND pay_status = 1', //申请售后

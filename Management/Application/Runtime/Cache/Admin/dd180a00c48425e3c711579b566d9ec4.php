                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td>启用分销：</td>
                                    <td >
                                       	 否<input type="radio" class="" name="distributor" value="0" <?php if($config[distributor] == 0): ?>checked="checked"<?php endif; ?>>
                                       	 是<input type="radio" class="" name="distributor" value="1" <?php if($config[distributor] == 1): ?>checked="checked"<?php endif; ?>>
                                    </td>
                                    <td class="col-sm-7"></td>
                                </tr>
                                  <tr>
                                    <td>一级分销比例：</td>
                                    <td >
                                        <input type="text" class="form-control" name="min" id="distribut_min" value="<?php echo ($config["classa"]); ?>"onpaste="this.value=this.value.replace(/[^\d]/g,'')" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" >
                                    </td>
                                    <td class="col-sm-7">%</td>
                                </tr>
                                <tr>
                                    <td>二级分销比例：</td>
                                    <td>
                                        <input type="text" class="form-control" name="min" id="distribut_min" value="<?php echo ($config["classb"]); ?>" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
                                    </td>
                                    <td class="col-sm-7">%</td>
                                </tr>
                                   <tr>
                                    <td>三级分销比例：</td>
                                    <td>
                                        <input type="text" class="form-control" name="min" id="distribut_min" value="<?php echo ($config["classc"]); ?>" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onkeyup="this.value=this.value.replace(/[^\d]/g,'')">
                                    </td>
                                    <td class="col-sm-7">%</td>
                                </tr>
                                </tbody> 

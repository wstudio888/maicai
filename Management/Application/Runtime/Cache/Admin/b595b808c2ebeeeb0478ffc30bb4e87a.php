...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Seller/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>商家版</b></span>
      </a>
...
<aside class="main-sidebar" style="overflow-y:auto;">
      <section class="sidebar">
        ...
        <li class="treeview">
              <a href="javascript:void(0)">
                <i class="fa <?php echo ($vo["icon"]); ?>"></i><span>快递员</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">                
                <li onclick="makecss(this)" data-id="<?php echo ($vv["act"]); ?>_<?php echo ($vv["control"]); ?>">
                  <a href='<?php echo U('Courier/courier');?>' target='rightContent'><i class="fa fa-circle-o"></i>快递员列表</a>
                </li>
                <li onclick="makecss(this)" data-id="<?php echo ($vv["act"]); ?>_<?php echo ($vv["control"]); ?>">
                  <a href='<?php echo U('Courier/express');?>' target='rightContent'><i class="fa fa-circle-o"></i>送单详情列表</a>
                </li>
                <li onclick="makecss(this)" data-id="<?php echo ($vv["act"]); ?>_<?php echo ($vv["control"]); ?>">
                  <a href='<?php echo U('Courier/courier_money');?>' target='rightContent'><i class="fa fa-circle-o"></i>提现申请列表</a>
                </li>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2015-2025 <a href="">沃商商城旗下产品</a>.</strong>保留所有权利。
	</footer>

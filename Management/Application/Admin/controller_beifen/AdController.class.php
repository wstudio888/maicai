...
class AdController extends BaseController{
    ...
    //     $upload->rootPath = 'Public/'; // 设置上传跟目录
    //     $upload->savePath = 'upload/ad/mv/'; // 设置附件上传目录

    //     // 上传文件 
    //     $info = $upload->uploadOne($_FILES['sss']);
    //     if(!$info) {// 上传错误提示错误信息
    //         $this->error($upload->getError());
    //     }else{// 上传成功
    //         $ad_code = 'https://yct.woshangapp.com/Public/'.$info['savepath'].$info['savename'];
    //         var_dump($ad_code);
    //         $this->success("操作成功",U('Admin/Ad/admv'));
    //       //  $this->redirect("Ad/admv",array("status"=>"100"));  
    //     }
    // }

	           	...
	           	<div class="box-header">
	                <nav class="navbar navbar-default">	     
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('Admin/Store/store_article_list');?>" method="post">
				            ...
				            <div class="form-group pull-right">
					            <a href="<?php echo U('Admin/Store/store_article_add',array('store_id'=>$store_id));?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加活动</a>
				            </div>		          
				          </form>		
				      	</div>
	    			</nav>               
	             ...
	             <div class="box-body">	             
	            	...
	            	<div class="col-sm-12">
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
		                 <thead>
		                   <tr role="row">
			                   <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 294px;">活动标题</th>        
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      ...
		                      <a class="btn btn-primary" href="<?php echo U('Store/store_article_edit',array('article_id'=>$vo['article_id'],'store_id'=>$store_id));?>"><i class="fa fa-pencil"></i></a>
		                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Store/store_article_handle');?>" data-id="<?php echo ($vo["article_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
							</td>

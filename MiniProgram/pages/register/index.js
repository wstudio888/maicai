...
Page({
  ...
  quick_register_phone: function (e) {
    ...
    if (parseInt(this.data.num).toString().length == 4) {
      ...
      console.log('https://wudhl.com/index.php/Api/User/register?phone=' + this.data.phoneNum + "&num=" + this.data.num + "&openid=" + app.globalData.openid + "&pass=" + this.data.pass + "&remindpass=" + this.data.remindpass + "&nickName=" + app.globalData.nickName);
      wx.request({
        url: 'https://wudhl.com/index.php/Api/User/register?phone=' + this.data.phoneNum + "&num=" + this.data.num + "&openid=" + app.globalData.openid + "&pass=" + this.data.pass + "&remindpass=" + this.data.remindpass + "&nickName=" + app.globalData.nickName,

                    ...
                    <form method="post" enctype="multipart/form-data" target="_blank" id="form-order">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" style="font-size:12px;">
                                ...
                                <tbody>
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr id="order_id_<?php echo ($list['order_id']); ?>">
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                           ...
                                           <?php if(($list['order_status'] == 3) or ($list['order_status'] == 5)): ?><a href="javascript:void(0)" onclick="ajax_delete_order(<?php echo ($list['order_id']); ?>)" data-toggle="tooltip" class="btn btn-danger" title="删除"><i class="fa fa-trash-o"></i></a>
                                           <?php else: ?>
...
<script>
	...
	function ajax_delete_order(order_id){

            $.ajax({
                type : "POST",
                url:"/index.php/Seller/order/delete_order/",//+tab,
				dataType:'json',
                data : {
					order_id:order_id
				},// 你的formid

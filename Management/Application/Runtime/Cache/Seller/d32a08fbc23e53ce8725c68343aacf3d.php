        ...
        <table class="table table-bordered table-hover">
            ...
            <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-right">
                        ...
                        <a onclick="document.location.href='/Seller/Goods/addEditGoods/goods_id/<?php echo ($list['goods_id']); ?>/curpage/'+$('#curpage').val()" href="javascript:void(0)"  data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-pencil"></i></a>

    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a onclick="get_help(this)" id="get_help" data-url="http://www.tp-shop.cn/Doc/Indexbbc/article/id/1072/developer/user.html" class="btn btn-default" href="javascript:;"><i class="fa fa-question-circle"></i> 帮助</a>                
            </div>
...
<!--                        <li><a href="#tab_goods_desc" data-toggle="tab">描述信息</a></li>-->
                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>商品简介:</td>
                                    <td>
	                                    <textarea rows="6" cols="55" name="goods_remark"><?php echo ($goodsInfo["goods_remark"]); ?></textarea>
                               ...
                               <!--  <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td>精品商品:</td>
                                    <td>
                                        是:<input type="radio" <?php if($goodsInfo[is_recommend] == 1): ?>checked="checked"<?php endif; ?> value="1" name="is_recommend" />
                                        否:<input type="radio" <?php if($goodsInfo[is_recommend] == 0): ?>checked="checked"<?php endif; ?> value="0" name="is_recommend" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>库存数量:</td>
                                ...
                                <tr>
                                    <td>商品详情描述:</td>
                                    <td width="85%">
										<textarea class="span12 ckeditor"  id="goods_content" name="goods_content" title="" value="<?php echo ($goodsInfo["goods_content"]); ?>"><?php echo ($goodsInfo["goods_content"]); ?></textarea>
                    ...
                    <div class="pull-right">
                        ...
                        <button class="btn btn-primary" onclick="ajax_submit_form('addEditGoodsForm','/Seller/Goods/addEditGoods/is_ajax/1/curpage/<?php echo ($_GET['curpage']); ?>')" title="" data-toggle="tooltip" type="button" data-original-title="保存">保存</button>
                    </div>
			    </form><!--表单数据-->
                </div>
            </div>
